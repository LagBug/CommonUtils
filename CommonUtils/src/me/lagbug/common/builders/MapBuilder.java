...
public class MapBuilder {
     ...
     */
    public MapBuilder setImage(@Nonnull final BufferedImage image) {
        this.image = image;
        return this;
    }
     ...
     * @return the instance of this class
     */
    public MapBuilder addText(@Nonnull final int x, @Nonnull final int y, @Nonnull final MapFont font, @Nonnull final String text) {
    ...
    public MapBuilder addCursor(@Nonnull final int x, @Nonnull final int y, @Nonnull final CursorDirection direction, @Nonnull final CursorType type) {
     ...
     * @return the instance of this class
     */
    public MapBuilder setRenderOnce(@Nonnull final boolean renderOnce) {
    ...
    public ItemStack build() {
        ...
        try {
        	...
        	CommonUtils.log("Could not get material for the current spigot version. This won't be shown again until server restats");
        }
     ...
     * @return the instance of this class
     */
    private short getMapId(@Nonnull final MapView mapView) {
        try {
...
class Text {
    ...
    public Text(@Nonnull final int x, @Nonnull final int y, @Nonnull final MapFont font, @Nonnull final String message) {
        setX(x);
        setY(y);
        setFont(font);
        setMessage(message);
    ...
    */
    public void setX(@Nonnull final int x) {
        this.x = x;
    }
     ...
     */
    public void setY(@Nonnull final int y) {
        this.y = y;
    }
     ...
     */
    public void setFont(@Nonnull final MapFont font) {
        this.font = font;
    }
